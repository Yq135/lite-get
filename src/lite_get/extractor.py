...
from .common import maybe_print, download_urls, get_filename, dry_run
...
class VideoExtractor():
    ...
    def p_stream(self, stream_id):
        ...
        if 'itag' in stream:
            print("    # download-with: %s" % log.sprint("lite-get --itag=%s [URL]" % stream_id, log.UNDERLINE))
        else:
            print("    # download-with: %s" % log.sprint("lite-get --format=%s [URL]" % stream_id, log.UNDERLINE))
    ...
    def download(self, **kwargs):
        ...
        if 'info_only' in kwargs and kwargs['info_only']:
            ...
            if 'stream_id' in kwargs and kwargs['stream_id']:
                ...
                if has_ffmpeg_installed() and self.dash_streams or not self.streams_sorted:
